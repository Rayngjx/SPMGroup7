...
const TeamScheduleCalendar = dynamic(() => import('@/components/dashboard/staffTeamSchedule/EnhancedWFHCalendar'), {
  ssr: false,
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <TeamScheduleCalendar currentUser={currentUser} departmentStaff={departmentStaff} />
      </Suspense>
    </div>
  )
}